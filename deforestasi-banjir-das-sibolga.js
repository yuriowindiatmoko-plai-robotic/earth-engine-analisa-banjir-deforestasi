// 0: [98.59365298994285,1.7131495234442564]
// 1: [98.82093265302879,1.7131495234442564]
// 2: [98.82093265302879,1.8572750543937442]
// 3: [98.59365298994285,1.8572750543937442]
// 4: [98.59365298994285,1.7131495234442564]
// =================================================================================
// Tapanuli & Sibolga: FIX ERROR "bands.contains is not a function"
// =================================================================================

// 1. AREA OF INTEREST
var aoi = ee.Geometry.Polygon([
  [[98.59365298994285,1.7131495234442564],
   [98.82093265302879,1.7131495234442564],
   [98.82093265302879,1.8572750543937442],
   [98.59365298994285,1.8572750543937442],
   [98.59365298994285,1.7131495234442564]]
]);
...
// --- 1. Import Data ---
var das_boundaries = ee.FeatureCollection('projects/project-banjir-480109/assets/Batas_DAS_KLHK');
// DAS: GAROGA Provinsi: Sumatera Utara (12)
...
var das_anai = sumatera_focus.filter(
  ee.Filter.and(
    ee.Filter.eq('kode_prov', 12), // Pastikan Sumut
    ee.Filter.eq('nama_das', 'GAROGA') // Pastikan namanya GAROGA
  )
);
...
// Tambahkan ke Peta
Map.addLayer(das_anai.style(style_anai), {}, '📍 FOKUS: DAS GAROGA');
